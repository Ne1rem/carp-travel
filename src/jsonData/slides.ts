...
export const slides: Slide[] = [
  {
    id: 1,
    picture: '/images/atvs.jpg',
    title: 'Feel the adrenaline rush',
    bg: '/images/slide-bg-atvs.jpg',
    description:
  ...
  {
    id: 2,
    picture: '/images/rock-climbing.jpg',
    title: 'Destroy your limitations',
    bg: '/images/slide-bg-rock-climbing.jpg',
    description:
  ...
  {
    id: 3,
    picture: '/images/hot-air-ballooning.jpg',
    title: 'Get Inspired',
    bg: '/images/slide-bg-hot-air-ballooning.jpg',
    description:
  ...
  {
    id: 4,
    picture: '/images/skydiving.jpg',
    title: 'Overcome your fears',
    bg: '/images/slide-bg-skydiving.jpg',
    description:
  ...
  {
    id: 5,
    picture: '/images/rafting.jpg',
    title: 'Trust the flow',
    bg: '/images/slide-bg-rafting.jpg',
    description:
      'Join exciting rafting expeditions on the waterways of the Carpathians. Go through challenging waterways and overcome gusty waves, feel the adrenaline, and enjoy the incredible views of the surrounding mountains.',
  },
];

export const sliderButtonText = [
  'Atvs Traveling',
  'Rock climbing',
  'Hot air ballooning',
  'Skydiving',
